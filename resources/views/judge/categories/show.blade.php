...
@section('content')
  <div class="flex flex-col h-full">
    ...
    @if (!$judge->pivot->completed)
      <div class="flex items-center justify-center flex-none w-full h-12 bg-white border-t">
        <div class="px-2">
